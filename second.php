...
#table_status tbody tr td{padding:3px;}
...
<!-- end page -->
<script src="<?php echo $_path?>js/on-off-switch.js"></script>
<script src="<?php echo $_path?>js/on-off-switch-onload.js"></script>
<script> 
      ...
      { 
		...
		$(document).on('click', '.function_reboot a', function(e)
		{
			...
			var html ='<h2>User</h2>';
				...
				html +='<div class="field_container"><input type="password" class="text" name="password" id="password" value="" required></div>';
				html +='</div><div class="input_container"><label for="headquarters"></label>';
      ...
      var localip      = $(this).data('name');
		...
		$(document).on('submit', '#form_company.add', function(e)
		{
			...
			// Validate form
			  ...
			  var request   = $.ajax({
				url:          './bond/process/sec.php?cmd=reboot&localip='+localip,
				cache:        false,
				data:         form_data,
				contentType:  false,
				type:         'get'
