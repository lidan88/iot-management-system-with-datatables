...
require("C:/xampp/htdocs/rpb/src/config.php");
...
require("C:/xampp/htdocs/rpb/src/reference/phpMQTT/phpMQTT.php");
...
function procmsg($topic,$msg){
	...
	{
		$sql = "insert into ".TBL_STATUS." set devId='$devId', status='$status', wdten='$wdten', serverIP='$serverIP', wdttime='$wdttime', localIP='$localIP',firmver='$firmver', statusTime='".date("Y-m-d H:i:s")."'";
		$result = mysqli_query($_db, $sql);
	}
	else
	{
		$sql = "update ".TBL_STATUS." set status='$status', wdten='$wdten', serverIP='$serverIP', wdttime='$wdttime', localIP='$localIP',firmver='$firmver', statusTime='".date("Y-m-d H:i:s")."' where devId='$devId'";
		$result = mysqli_query($_db, $sql);
	}
